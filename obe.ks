user --name=ekthor --groups=users,wheel,mock,docker,vboxsf,libvirt,input,qemu,kvm,systemd-journal,pkg-build --password=12345678 --shell=/usr/bin/zsh
user --name=ramser --groups=users,wheel,mock,docker,vboxsf,libvirt,input,qemu,kvm,systemd-journal,pkg-build --password=12345678 --shell=/usr/bin/zsh
